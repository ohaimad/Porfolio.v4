...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [] }) => {
  ...
  const handleButtonClick = () => {
    ...
    if (activeItem.video) {
      window.open(activeItem.video, '_blank'); // Opens in new tab
      return;
    }
  ...
  return (
    <div className="relative w-full h-full">
      <canvas
        ...
        ref={canvasRef}
        className="cursor-grab w-full h-full overflow-hidden relative outline-none active:cursor-grabbing rounded-[100px]"
      />
